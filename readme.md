...
&emsp;12月8日，Maggie在XChat聊天室的xq102210频道发送了他的二次元图片，随后小张回应“上次（AI）把我的证件照给……”。小张刚说完这句话，就引起一群“吃瓜群众”议论纷纷，议论的内容包括“变.性”、“女装”等。所有信息都是由ZhangHelper记录的。  
```
//图片地址会被“【不可描述】”代替
...
[2022-12-08 20-19-47] [5jbXdS]MolenCmd @小张 （AI把你化成女生的）图片发我看看
...
```
由此可见，此事件是Maggie和小张引起的，但他们二人并没有违规，因为Maggie发的图片不是真正的色情图片，小张始终没有偏向色情。但随后由于人类的本能，导致发生人传人连锁反应。值得一提的是，在那天晚上有人在Maggie的博客评论区要求他分享涩图，发送者的IP归属地竟然是新疆乌鲁木齐，和fish在同一个归属地  
```
